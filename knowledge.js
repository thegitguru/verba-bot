const VERBA_KNOWLEDGE = {
  syntax: [
    ...
    { topic: "Null Safety & Option Types", keywords: ["option", "options", "null safety", "nullable", "optional", "some", "none", "unwrap", "unwrap_or", "or_else"], description: "Verba supports first-class option values with `some <expr>` and `none`. Use `is some` / `is none` in conditions, then safely read values with `unwrap`, `unwrap_or`, or `or_else`.", example: "name = some \"Verba\".\nmissing = none.\nif name is some:\n    safe_name = the result of running name.unwrap.\nend.\nfallback = the result of running missing.unwrap_or with \"Anonymous\"." },
